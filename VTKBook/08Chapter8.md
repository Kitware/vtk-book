...
```
    type = GetCellType()
     ...
     Clip(value, cellScalars, locator, cells, inputPointData, outputPointData, insideOut)
          ...
          locator object (see ["Searching"](#87-searching) in [Chapter 8](/VTKBook/08Chapter8)) which merges coincident points, and the
